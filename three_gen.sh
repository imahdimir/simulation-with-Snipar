...
# # I removed the parental geneartion rows from pgs files, keeping only offspring

# # k
pgs.py direct_obs --pgs direct_obs_offspring.pgs.txt --phenofile phenotype.txt --h2f ,0  --scale_phen --scale_pgs
pgs.py direct_v1_obs --pgs direct_v1_obs_offspring.pgs.txt --phenofile phenotype.txt --h2f 0.4134823,0 --scale_phen --scale_pgs
pgs.py direct_v10_obs --pgs direct_v10_obs_offspring.pgs.txt --phenofile phenotype.txt --h2f 0.4134823,0 --scale_phen --scale_pgs
...
pgs.py direct_imp --pgs direct_imp_offspring.pgs.txt --phenofile phenotype.txt --gen_models 3 --scale_phen --scale_pgs
pgs.py direct_v1_imp --pgs direct_v1_imp_offspring.pgs.txt --phenofile phenotype.txt --gen_models 3 --scale_phen --scale_pgs
pgs.py direct_v10_imp --pgs direct_v10_imp_offspring.pgs.txt --phenofile phenotype.txt --gen_models 3 --scale_phen --scale_pgs
